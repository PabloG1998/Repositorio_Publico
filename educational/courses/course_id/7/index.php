...
<body>
  ...
  <div class="card-body">
    <blockquote class="blockquote mb-0">
      <p>
        El <b>Couching</b> 
       es una metodología de apoyo y desarrollo que facilita a los individuos el logro de sus metas,
       el descubrimiento de su potencial y la mejora de sus habilidades. Se centra en la acción y en
       el futuro, en lugar de analizar el pasado.
      </p>
    ...
    <div class="container mt-5">
        <h2>Formulario de Inscripción a Couching</h2>
        <form id="RegistrationForm" action="index.php" method="post">
            ...
            <input type="text" class="form-control" id="course" name="course" value="Curso de Couching" readonly>
        </div>
