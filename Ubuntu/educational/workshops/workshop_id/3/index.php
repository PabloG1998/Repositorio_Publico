  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="../../../../educational/accompaniment/">Acompañamientos</a>
        </li>
        <li class="nav-item">
...
<br> <br>
  ...
  <div class="card-header">
    Taller de Niño Interior
  </div>
  <div class="card-body">
    <blockquote class="blockquote mb-0">
      <p>
       Trabajar con el <b>Niño Interior</b> implica reconectar con esas emociones y experiencias del pasado
       para sanar heridas emocionales, superar traumas y desarrollar una relación más saludable consigo mismo.
       El objetivo es integrar esa parte vulnerable del ser con el adulto que somos hoy, logrando mayor bienestar emocional,
    ...
    <div class="container mt-5">
        <h2>Formulario de Inscripción a Taller de Niño Interior</h2>
        <form id="RegistrationForm" action="index.php" method="post">
            ...
            <input type="text" class="form-control" id="course" name="course" value="Taller de Niño Interior" readonly>
        </div>
        <button type="button" class="btn btn-primary" id="inscribirseBtn" data-bs-toggle="modal" data-bs-target="#comprobanteModal">Inscribirse</button>
        </form>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="uploadForm" action="index.php" method="post" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="course" value="Taller de Niño Interior">
                        <div class="mb-3">
