...
<body>
  ...
  <div class="card-body">
    <blockquote class="blockquote mb-0">
      <p>
        Un <b>Operador Socio Comunitario en  Adicciones</b> es un profesional capacitado para intervenir en contexto
        comunitarios, brindando apoyo, orientación y contención a personas que enfrentan problemas de adicciones. Su labor
        se centra en la prevención, promoción de la salud y acompañamiento en procesos de recuperación. Trababaja en conjunto
        con otros profesionales de la salud, organizaciones y la comunidad para desarrollar estrategias que promuevan estilos
        de vida saludables y reduzcan el impacto de las adicciones en la sociedad. Además suele actuar como mediador y facilitador
        en el acceso a recursos y servicios especializados.
      </p>
