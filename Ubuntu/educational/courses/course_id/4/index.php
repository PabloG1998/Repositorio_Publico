...
<body>
  ...
  <div class="card-body">
    <blockquote class="blockquote mb-0">
      <p>
        La <b>Biodecodificación</b> 
       es una terapia alternativa que sugiere que las enfermedades físicas están vinculadas a conflictos emocionales
       o traumas no resueltos. Según esta práctica, al identificar y resolver estos conflictos emocionales, es posible promover
       la curación física del cuerpo
      </p>
    ...
    <div class="container mt-5">
        <h2>Formulario de Inscripción a Biodecodificación</h2>
        <form id="RegistrationForm" action="index.php" method="post">
            ...
            <input type="text" class="form-control" id="course" name="course" value="Curso de Biodecodificacion" readonly>
        </div>
