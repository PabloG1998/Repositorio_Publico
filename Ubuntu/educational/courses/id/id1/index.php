...
<div class="container">
    <div class="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
      <div class="col-12 col-lg-6">
        <img class="img-fluid rounded" loading="lazy" src="../../../../resources/example-images/php.png" alt="About 2">
      </div>
      <div class="col-12 col-lg-6">
        <div class="row justify-content-xl-center">
          <div class="col-12 col-xl-10">
            <h2 class="mb-3">Curso 1</h2>
            <p class="lead fs-4 mb-3 mb-xl-5">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Laudantium, facilis libero laboriosam perspiciatis minima veniam iste autem facere error in, tempore repellendus quasi similique quibusdam porro corrupti assumenda ex et.</p>
            <div class="d-flex align-items-center mb-3">
              ...
              <div>
                <p class="fs-5 m-0">Lorem ipsum dolor sitimpedit iusto quo doloribus veniam eaque officia delectus sit quam vitae totam.</p>
              </div>
            </div>
            <div class="d-flex align-items-center mb-3">
              <div class="me-3 text-primary">
              ...
              <div>
                <p class="fs-5 m-0">Lorem ipsum dopsa dicta distinctio?</p>
              </div>
            </div>
            <div class="d-flex align-items-center mb-4 mb-xl-5">
              ...
              <div>
                <p class="fs-5 m-0">Lorem ipsum dolor sit, amet coid quis! Ab.</p>
              </div>
            </div>
            <form action="">
            <button type="button" class="btn bsb-btn-xl btn-outline-primary rounded-pill">Anotarme!</button>
            </form>
          </div>
        </div>
      </div>
